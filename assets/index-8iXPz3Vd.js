 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ur=o=>o.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),A=(o,e)=>{const r=f.forwardRef(({color:t="currentColor",size:s=24,strokeWidth:n=2,absoluteStrokeWidth:i,className:l="",children:p,...c},h)=>f.createElement("svg",{ref:h,...dr,width:s,height:s,stroke:t,strokeWidth:i?Number(n)*24/Number(s):n,className:["lucide",`lucide-${ur(o)}`,l].join(" "),...c},[...e.map(([g,b])=>f.createElement(g,b)),...Array.isArray(p)?p:[p]]));return r.displayName=`${o}`,r};/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
